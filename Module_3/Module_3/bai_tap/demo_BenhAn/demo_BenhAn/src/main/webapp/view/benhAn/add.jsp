...
<div class="container" style="margin-left: 100px">
    <form action="/benhAn?action=add" method="post">
        <h1>TRANG THÊM MỚI BỆNH ÁN</h1>
        <div class="form-floating mb-3">
            <input type="text" name="maBenhAn" id="maBenhAn" class="form-control" placeholder="Nhập Mã Bệnh Án " required>
        ...
        <div class="form-floating mb-3">
            <input type="date" name="ngayNhapVien" id="ngayNhapVien" class="form-control"  required>
            <label for="ngayNhapVien" class="form-label">Nhập Ngày Nhập Viện</label>
        </div>
        <div class="form-floating mb-3">
            <input type="date" name="ngayRaVien" id="ngayRaVien" class="form-control"  required>
            <label for="ngayRaVien" class="form-label">Nhập Ngày Ra Viện</label>
        </div>
        <div class="form-floating mb-3">
            <input type="text" name="lyDoNhapVien" id="lyDoNhapVien" class="form-control" placeholder="Nhập Lý Do Nhập Viện" required>
